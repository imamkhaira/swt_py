...
class Home(HomeController, Frame):
    def __init__(self, parent_window: Tk):
        ...
        swtLogo = ImageLabel(self, Image.open("etc/logo.png"))
        button1 = Button(self, text="Character Recognition", command=self.launch_recognition)
        button2 = Button(self, text="Character Learning", command=self.launch_learning)
        ...
        padx, pady = 10, 5
        swtLogo.grid(row=0, column=0, columnspan=2, padx=padx, pady=pady, sticky=(E, W))
